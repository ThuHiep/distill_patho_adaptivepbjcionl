...
- **Cửa top-tier còn lại = ĐÀO SÂU KHOA HỌC (không thêm module):** phát triển câu hỏi *"cái gì sống sót qua nén — đếm hay bất định?"* thành insight có **cơ chế** (vì sao PB-σ structural vỡ dưới nén, learned-σ sống: teacher PB-σ tựa per-instance detection-confidence student tí hon không tái tạo nổi; learned-σ tựa aggregate error) + làm N4 hết scheme-dependent. **Khó, thêm việc, odds không chắc — nhưng là cửa THẬT.**
