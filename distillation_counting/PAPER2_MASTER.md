...
8. → **VIẾT manuscript**: đóng gói "Distributional Count Distillation under mean-variance optimization conflict", KHÔNG claim PB-JCI (=P1); hình ~4–5. **Lead = distillation + label-efficiency (§4.10) + N2-Poisson-σ + PanNuke comparative-win (§4.2); KHÔNG lead UQ; KHÔNG dùng "distribution distillation".**
