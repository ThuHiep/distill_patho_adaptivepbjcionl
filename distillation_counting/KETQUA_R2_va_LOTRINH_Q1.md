...
- Student thắng **MAE + RMSE** (13.51/22.61 thấp nhất) dù nhỏ 86–368× → điểm bán chính.
- NHƯNG **LKCell MAPE 38.8% < student 45.3%** → LKCell sai TƯƠNG ĐỐI thấp hơn; **student KHÔNG thắng tuyệt đối
  mọi metric** → PHẢI ghi rõ, không nói "giỏi nhất mọi mặt".
- LKCell (16.54) gần student hơn CellViT-SAM-H (24.24) — hợp lý (LKCell 2024 > SAM-H trên PanNuke). Cả 2 heavy
  bám GT (đơn điệu) nhưng undercount OOD (ratio~0.65-0.77).
